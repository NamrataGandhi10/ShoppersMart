...
namespace ShoppersMart.Web.Helper;
...
public class SessionValidationAttribute : ActionFilterAttribute
{
    ...
    {
        if (!context.HttpContext.Request.Cookies.Keys.Contains("_ShopMartCookie") && !context.HttpContext.Session.Keys.Contains("UserId"))
        {
