...
namespace ShoppersMart.API.Repository.Service;

public class OrderService : IOrderService
{
    private readonly ShoppersMartChallengeDbContext _db;

    public OrderService(ShoppersMartChallengeDbContext dbContext) => _db = dbContext;
    ...
    public async Task<OperationResult<List<OrderItemModel>>> GetOrderData(int id)
    {
